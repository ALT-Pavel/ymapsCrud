            ...
            <div class="col-md-6">
                <form @submit.prevent="updateMarker">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="marker.longitude">
                    </div><br>
...
export default {
    ...
    created() {
        this.$axios.get('/sanctum/csrf-cookie').then(response => {
            this.$axios.get(`/api/markers/edit/${this.$route.params.id}`)
                .then(response => {
    ...
    methods: {
        updateMarker() {
            this.$axios.get('/sanctum/csrf-cookie').then(response => {
                this.$axios.post(`/api/markers/update/${this.$route.params.id}`, this.marker)
                    .then(response => {
